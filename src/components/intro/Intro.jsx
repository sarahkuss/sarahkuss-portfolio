    ...
    <main>
      <Container className="intro-cont">
        ...
        <Col sm={12} md={6} className="text-col">
          ...
          <p>
            Always learning, I strive to stay up-to-date on the latest technological trends and advancements. I am currently interning as a Web3 Software Engineer, working on a women-led NFT that raises money for scholarships that go to women pursuing tech.   
          </p>
          <p>
